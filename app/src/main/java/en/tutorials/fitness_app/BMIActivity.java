        ...
        mviewRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.getCount() == 0) {
                    Toast.makeText(BMIActivity.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
                }
...
//                    toast.show();
                    ...
                    if (check == true) {
                        Toast.makeText(BMIActivity.this, "Insertion Successful", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(BMIActivity.this, "Insertion Failed", Toast.LENGTH_SHORT).show();
                    }


                    Intent intent =new Intent(BMIActivity.this,calActivity.class);
